...
return [
    ...
    | например, правила размера. Вы можете настроить эти сообщения здесь.
    |
    */
    ...
    */
    ...
    'custom' => [
        ...
        'username' => [
            ...
            'alpha_dash' => 'Логин может содержать только буквы, цифры, дефис и нижнее подчеркивание',
        ],
        'email' => [
        ...
        'password' => [
            ...
            'regex' => 'Пароль должен содержать минимум 8 символов, включая заглавные и строчные буквы, а также цифры',
        ],
    ],
